...
- 10:05 - 10:30 AM > Stefani Tsaneva, Stefan Vasic, Marta Sabou. [''*LLM-driven Ontology Evaluation: Verifying Ontology Restrictions with ChatGPT*''](assets/paper_1.pdf) 
